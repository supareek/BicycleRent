 ...
 * Helper class to show Snack bar at application level.
 */
public class GlobalSnackBar {
    ...
    @NonNull
    public static GlobalSnackBar make(@NonNull Context applicationContext, @NonNull CharSequence text, @Snackbar.Duration int duration)
    {
        return new GlobalSnackBar(applicationContext, text, duration);
    }

    private GlobalSnackBar(@NonNull final Context appplicationContext, @NonNull CharSequence text, @Snackbar.Duration int duration)
    {
    ...
    private void onSnackbarContainerAttached(final View rootView, final CoordinatorLayout snackbarContainer)
    {
        ...
        textView.setTextColor(Color.parseColor("#FFE385"));
    ...
    @NonNull
    public GlobalSnackBar setCallback(@Nullable Snackbar.Callback callback)
    {
    ...
    @NonNull
    public GlobalSnackBar setAction(CharSequence text, final View.OnClickListener listener)
    {
